  ...
  PDF_CLASSES = {}.tap do |hash|
    {
      ...
      Pdfs::PatientListing => %w[patient_listing],
      Pdfs::PatientListingPrescriber => %w[patient_listing_p],
      Pdfs::SummaryPatientListing => %w[summary_patient_listing],
      Pdfs::UnaccumulatedAddresses => %w[unaccumulated_addresses address_report],
      Pdfs::Tags => %w[tags],
      Pdfs::DepositsInBanks => %w[deposits_in_banks],
      Pdfs::ClosingAudit => %w[closing_audit],
